       ...
       <div className="flex">
        ...
        <div className="flex bg-white   max-[950px]:hidden shadow-[0_4px_6px_0_rgba(67,46,134,0.04)]   rounded-[14px] border-[#CECEEA] border-[0.8px] p-[5px]">
          <div className="hover:bg-[#f1f2f3]  rounded-lg">
            <button className="flex items-center px-[12px] pt-2 text-sm  rounded-xl hover:bg-[#f1f2f3] font-[family-name:var(--font-axiforma-sans)]">
              Product
              <FaChevronDown size={10}  className="ml-2"/>
            </button>
          </div>
          <div className="hover:bg-[#f1f2f3] rounded-lg">
            <button className="flex items-center  text-sm px-[12px] pt-2 rounded-xl hover:bg-[#f1f2f3] font-[family-name:var(--font-axiforma-sans)] ">
        ...
        <div className="flex bg-white  border max-[992px]:hidden border-[#CECEEA]  cursor-pointer    rounded-[14px] p-[5px] ">
            <span
              className="text-sm rounded-lg  px-[12px] pt-[8px] hover:bg-[#f1f2f3]  font-[family-name:var(--font-axiforma-sans)]"
            >
              Contact Sales
            </span>
          </div>
